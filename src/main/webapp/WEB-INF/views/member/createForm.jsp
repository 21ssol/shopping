...
<head>
  ...
  function idCheck(id){  // 아이디 중복확인 비동기 통신으로
	  if(id==''){
		  alert("아이디를 입력하세요");
		  document.frm.id.focus();
	  }else{
		  var url = "idcheck";  // controller에서 작업
		  var param = "id="+id;
		  
		  $.get(url, param, function(data, textStatus) {

			  $("#idcheck").text(data.str);   // .str ->json형식
		  })
	  }
  } 
...
<label class="col-sm-offset-2 col-sm-10">(<span id="need">*</span> 필수입력사항)</label>
  <form class="form-horizontal" 
    ...
    <div class="form-group">
      ...
      onclick="idCheck(document.frm.id.value)">ID 중복확인</button>  <!-- 비동기통신으로 -->
      <div id="idcheck"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">          
      <!-- input type을 email로 하면 저절로 적용된다. -->
